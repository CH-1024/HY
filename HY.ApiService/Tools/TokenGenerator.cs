...
namespace HY.ApiService.Tools
{
    ...
    {
        public static string GenerateAccessToken(long userId, string deviceId, int devicePlatform, out DateTime expires)
        {
            ...
            var claims = new[]
            {
                ...
                new Claim("DevicePlatform", devicePlatform.ToString()),
